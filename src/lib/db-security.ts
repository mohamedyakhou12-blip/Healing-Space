...
const COLLECTION_FIELDS: Record<string, Set<string>> = {
  ...
  courses: new Set([
    ...
    "instructorAr", "instructorFr", "instructorEn",
  ...
  articles: new Set([
    ...
    "description", "descriptionAr", "descriptionFr", "descriptionEn",
    "content", "contentAr", "contentFr", "contentEn",
    "excerpt", "excerptAr", "excerptFr", "excerptEn",
  ...
  podcasts: new Set([
    "id", "title", "titleAr", "titleFr", "titleEn",
    "description", "descriptionAr", "descriptionFr", "descriptionEn",
    "audioUrl", "image", "thumbnail", "status", "isFree", "price",
    "episode", "duration", "author", "instructor", "category", "tags", "viewCount",
    "metaTitleAr", "metaTitleFr", "metaTitleEn",
    "metaDescAr", "metaDescFr", "metaDescEn",
    "ogImage",
    "createdAt", "updatedAt",
  ...
  videos: new Set([
    "id", "title", "titleAr", "titleFr", "titleEn",
    "description", "descriptionAr", "descriptionFr", "descriptionEn",
    "videoUrl", "image", "thumbnail", "status", "isFree", "price",
    "duration", "category", "tags", "viewCount",
    "metaTitleAr", "metaTitleFr", "metaTitleEn",
    "metaDescAr", "metaDescFr", "metaDescEn",
    "ogImage",
    "createdAt", "updatedAt",
  ...
  pdfResources: new Set([
    "id", "title", "titleAr", "titleFr", "titleEn",
    "description", "descriptionAr", "descriptionFr", "descriptionEn",
    "pdfUrl", "fileUrl", "fileSize", "pageCount", "pages",
    "image", "thumbnail", "status", "isFree", "price",
    "author", "category", "tags", "viewCount",
    "metaTitleAr", "metaTitleFr", "metaTitleEn",
    "metaDescAr", "metaDescFr", "metaDescEn",
    "ogImage",
    "createdAt", "updatedAt",
  ...
  liveSessions: new Set([
    "id", "title", "titleAr", "titleFr", "titleEn",
    "description", "descriptionAr", "descriptionFr", "descriptionEn",
    "youtubeUrl", "streamUrl", "zoomUrl",
    "image", "thumbnail", "status", "isFree", "price",
    "duration", "scheduledAt", "category", "tags", "viewCount",
    "metaTitleAr", "metaTitleFr", "metaTitleEn",
    "metaDescAr", "metaDescFr", "metaDescEn",
    "ogImage",
    "createdAt", "updatedAt",
  ...
  purchases: new Set([
    ...
    "ccp", "ccpNumber", "receiptUrl", "receiptImage",
    "contentTitle", "contentTitleAr", "contentTitleFr", "contentTitleEn",
    "status", "adminNote",
    "createdAt", "updatedAt",
  ]),
