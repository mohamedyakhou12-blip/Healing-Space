...
//  2. Hardcoded fallback (healing-space-88247 project)
//
...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || "AIzaSyBDfFH4d3WaZOgKVz-OO1l0WbE0Y0JjZME",
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || "healing-space-88247.firebaseapp.com",
  databaseURL: process.env.NEXT_PUBLIC_FIREBASE_DATABASE_URL || "https://healing-space-88247-default-rtdb.firebaseio.com",
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "healing-space-88247",
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "healing-space-88247.firebasestorage.app",
  messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "873540723647",
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "1:873540723647:web:8ee71a96bb91f4b5b1a058",
};
