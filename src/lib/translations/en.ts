const en = {
  ...
  auth: {
    ...
    expiredResetLink: "The reset link has expired. Please request a new one.",
  ...
  admin: {
    ...
    confirmDeleteChapter: "Are you sure you want to delete this chapter and all its lessons?",
    confirmDeleteLesson: "Are you sure you want to delete this lesson?",
    videoUrl: "Video URL",
    isFreeLesson: "Free Lesson",
    orderField: "Order",
